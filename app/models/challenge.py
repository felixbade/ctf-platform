...
class Challenge(db.Model):
    ...
    solutions = db.relationship('UserSolution', backref='challenge', cascade='delete', lazy=True)
    feedback = db.relationship('UserFeedback', backref='challenge', cascade='delete', lazy=True)
